...
#ifndef BLINKHASH_UTIL_SYSCALL_SANDBOX_H
#define BLINKHASH_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during blinkhashd initialization if Blinkhash Core was compiled
...
#endif // BLINKHASH_UTIL_SYSCALL_SANDBOX_H
