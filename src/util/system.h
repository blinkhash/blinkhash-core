 ...
 */
#ifndef BLINKHASH_UTIL_SYSTEM_H
#define BLINKHASH_UTIL_SYSTEM_H
...
extern const char * const BLINKHASH_CONF_FILENAME;
extern const char * const BLINKHASH_SETTINGS_FILENAME;
