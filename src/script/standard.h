...
#ifndef BLINKHASH_SCRIPT_STANDARD_H
#define BLINKHASH_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a blinkhash address
 */
...
/**
 * Generate a Blinkhash scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // BLINKHASH_SCRIPT_STANDARD_H
