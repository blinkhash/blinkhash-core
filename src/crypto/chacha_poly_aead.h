...
#ifndef BLINKHASH_CRYPTO_CHACHA_POLY_AEAD_H
#define BLINKHASH_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@blinkhash.
 *
 ...
 *
 * The chacha20-poly1305@blinkhash combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@blinkhash cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@blinkhash are relatively fast in
...
#endif // BLINKHASH_CRYPTO_CHACHA_POLY_AEAD_H
