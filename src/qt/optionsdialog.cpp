    ...
    mapper(nullptr)
{
    ...
    ui->blinkhashAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->blinkhashAtStartup);
    ...
    ui->blinkhashAtStartup->setToolTip(ui->blinkhashAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->blinkhashAtStartup->setText(ui->blinkhashAtStartup->text().arg(PACKAGE_NAME));

    ui->openBlinkhashConfButton->setToolTip(ui->openBlinkhashConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BlinkhashUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->blinkhashAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBlinkhashConfButton_clicked()
{
