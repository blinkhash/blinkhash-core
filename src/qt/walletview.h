...
#ifndef BLINKHASH_QT_WALLETVIEW_H
#define BLINKHASH_QT_WALLETVIEW_H
...
private:
    ...
    //!
    //! The wallet model represents a blinkhash wallet, and offers access to
...
#endif // BLINKHASH_QT_WALLETVIEW_H
