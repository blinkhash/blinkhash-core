...
#ifndef BLINKHASH_INTERFACES_NODE_H
#define BLINKHASH_INTERFACES_NODE_H
...
//! Top-level interface for a blinkhash node (blinkhashd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BLINKHASH_INTERFACES_NODE_H
