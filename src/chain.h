...
#ifndef BLINKHASH_CHAIN_H
#define BLINKHASH_CHAIN_H
...
/** Return name of algorithm depending on algo-id, */
std::string GetAlgoName(int algo);
/** Return algo-id of algorithm depending on name */
