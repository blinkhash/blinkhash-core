...
#ifndef BLINKHASH_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define BLINKHASH_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // BLINKHASH_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
