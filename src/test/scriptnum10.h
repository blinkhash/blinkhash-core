...
#ifndef BLINKHASH_TEST_SCRIPTNUM10_H
#define BLINKHASH_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Blinkhash Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BLINKHASH_TEST_SCRIPTNUM10_H
