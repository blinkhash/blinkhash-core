...
{
    std::string strSecret = std::string("Q8e61P4rBgWCrnv3HZAdeEqXoznfLFPn6aDMFNa8e3bkEVt85Qz9");
    ...
    std::vector<unsigned char> expected = ParseHex("0387abd3080000000000000001");
