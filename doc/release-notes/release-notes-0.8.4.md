Blinkhash-Qt version 0.8.4 is now available from:
...
code, causing the Blinkhash-Qt or blinkhashd process to crash.
...
Linux: clicking on blinkhash: links was broken if you were using
a Gnome-based desktop.

Fix a hang-at-shutdown bug that only affects users that compile
their own version of Blinkhash against Boost versions 1.50-1.52.
