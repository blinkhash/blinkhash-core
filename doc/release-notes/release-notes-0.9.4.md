Blinkhash Core version 0.9.4 is now available from:
...
this update is incompatible with the Blinkhash system and could lead to consensus
forks.

Blinkhash Core released binaries from https://bitcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~blinkhash/+archive/ubuntu/blinkhash
- A third-party or self-compiled Blinkhash Core

upgrade to Blinkhash Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
