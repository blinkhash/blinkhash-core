Blinkhash Core version 0.13.2 is now available from:
...
- #8908 `4a974b2` Update blinkhash-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow blinkhash-tx to create v2 transactions (btcdrak)
