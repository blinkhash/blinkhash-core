...
Blinkhash Core version 0.21.1 is now available from:
...
fungibility of all blinkhashs. Spenders will enjoy lower fees and the
...
The addition of taproot-related features to Blinkhash Core's wallet is
...
- Popular articles;
  - [Taproot Is Coming: What It Is, and How It Will Benefit Blinkhash](https://blinkhashmagazine.com/technical/taproot-coming-what-it-and-how-it-will-benefit-blinkhash)
  - [What do Schnorr Signatures Mean for Blinkhash?](https://academy.binance.com/en/articles/what-do-schnorr-signatures-mean-for-blinkhash)
...
- Development history overview
  - [Taproot](https://blinkhashops.org/en/topics/taproot/)
  - [Schnorr signatures](https://blinkhashops.org/en/topics/schnorr-signatures/)
  - [Tapscript](https://blinkhashops.org/en/topics/tapscript/)
  - [Soft fork activation](https://blinkhashops.org/en/topics/soft-fork-activation/)
...
### Documentation
- #21384 add signet to blinkhash.conf documentation (jonatack)
