Blinkhash version 0.5.4 is now available for download at:
...
Fix Blinkhash-Qt notifications under Growl 1.3.
Increase required age of Blinkhash-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBlinkhash properly when installing Blinkhash-Qt over it. (Windows)
