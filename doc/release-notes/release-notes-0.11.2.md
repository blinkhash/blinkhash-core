Blinkhash Core version 0.11.2 is now available from:
...
- Block versions over the last 50,000 blocks as progress towards BIP65
  consensus enforcement: <http://blinkhash.sipa.be/ver-50k.png>

- Block versions over the last 2,000 blocks showing the days to the
  earliest possible BIP65 consensus-enforced block: <http://blinkhash.sipa.be/ver-2k.png>

**Notice to miners:** Blinkhash Core’s block templates are now for
version 4 blocks only, and any mining software relying on its
getblocktemplate must be updated in parallel to use libblkmaker either
version 0.4.3 or any version from 0.5.2 onward.

- If you are solo mining, this will affect you the moment you upgrade
  Blinkhash Core, which must be done prior to BIP65 achieving its 951/1001
  status.
...
Blinkhash transactions currently may specify a locktime indicating when
...
entire blockchain after an unclean shutdown of Blinkhash Core on Windows
...
- #6600 `1e672ae` Debian/Ubuntu: Include blinkhash-tx binary
- #6600 `2394f4d` Debian/Ubuntu: Split blinkhash-tx into its own package
