Blinkhash Core version 0.11.1 is now available from:
...
one was randomly violated by all deployed blinkhash software prior to
...
Blinkhash Core has produced compatible signatures since a28fb70e in
September 2013, but this didn't make it into a release until 0.9
in March 2014; Blinkhashj has done so for a similar span of time.
Blinkhashjs and electrum have been more recently updated.
...
[1] On the Malleability of Blinkhash Transactions
Marcin Andrychowicz, Stefan Dziembowski, Daniel Malinowski, Łukasz Mazurek
http://fc15.ifca.ai/preproceedings/blinkhash/paper_9.pdf
...
- #6571 `100ac4e` libblinkhashconsensus: avoid a crash in multi-threaded environments
