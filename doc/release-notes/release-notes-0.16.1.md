Blinkhash Core version 0.16.1 is now available from:
...
- #12843 `df38b13` Test starting blinkhashd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure blinkhashd processes are cleaned up when tests end (sdaftuar)
