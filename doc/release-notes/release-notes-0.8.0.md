Blinkhash-Qt version 0.8.0 is now available from:
...
Mac and Windows binaries are signed with certificates owned by the Blinkhash
...
New/changed settings (command-line or blinkhash.conf file)
--------------------------------------------------------
