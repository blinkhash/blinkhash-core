...
Assumeutxo is a feature that allows fast bootstrapping of a validating blinkhashd
...
considered active. This is the "traditional" mode of operation for blinkhashd.
...
**Failure consideration:** if blinkhashd unexpectedly halts after `m_stop_use` is set on
...
### Blinkhashd restarts sometime after snapshot validation has completed

When blinkhashd initializes again, what began as the snapshot chainstate is now
