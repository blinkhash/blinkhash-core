...
class TxDownloadTest(BlinkhashTestFramework):
    ...
    def test_inv_block(self):
        ...
        tx = self.nodes[0].createrawtransaction(
            ...
            outputs={ADDRESS_BCRT1_UNSPENDABLE: 5000 - 0.00025},
        )
    ...
    def run_test(self):
        ...
        # Run each test against new blinkhashd instances, as setting mocktimes has long-term effects on when
