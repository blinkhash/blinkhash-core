...
By default, blinkhashd will dump mempool on shutdown and
...
class MempoolPersistTest(BlinkhashTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent blinkhashd from writing mempool.dat to disk. Verify that `savemempool` fails")
