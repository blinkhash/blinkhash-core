...
class WalletLabelsTest(BlinkhashTestFramework):
    ...
    def run_test(self):
        ...
        # the same address, so we call twice to get two addresses w/5000 each
        ...
        # each with 1 address with a balance of 5000 Blinkhashs
        ...
        # send 5000 from each address to a third address not in this wallet
        ...
        if self.options.descriptors:
            ...
            for l in BECH32_INVALID:
                ...
                assert_raises_rpc_error(
                    -5,
                    "Address is not valid" if self.options.descriptors else "Invalid Blinkhash address or script",
