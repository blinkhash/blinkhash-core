...
class RPCPackagesTest(BlinkhashTestFramework):
    ...
    def test_conflicting(self):
        ...
        output1 = {node.get_deterministic_priv_key().address: 5000 - 0.00125}
        output2 = {ADDRESS_BCRT1_P2WSH_OP_TRUE: 5000 - 0.00125}
    ...
    def test_rbf(self):
        ...
        output = {node.get_deterministic_priv_key().address: 5000 - fee}
