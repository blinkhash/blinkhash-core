...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BlinkhashTestFramework
    pass


class ExampleTest(BlinkhashTestFramework):
    # Each functional test is a subclass of the BlinkhashTestFramework class.
    ...
    def custom_method(self):
        ...
        BlinkhashTestFramework class so other tests can use it."""
