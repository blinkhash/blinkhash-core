...
class ConfArgsTest(BlinkhashTestFramework):
    ...
    def run_test(self):
        ...
        conf_file = os.path.join(default_data_dir, "blinkhash.conf")
        ...
        none_existent_conf_file = os.path.join(default_data_dir, "none_existent_blinkhash.conf")
