...
class P2PPermissionsTests(BlinkhashTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].blinkhashconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].blinkhashconf, 'w', encoding="utf8") as f:
            f.write(newText)
