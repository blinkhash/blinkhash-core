...
"""
Test starting blinkhashd with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(BlinkhashTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that blinkhashd has bound on "::1" (for RPC) and "::" (for P2P).
