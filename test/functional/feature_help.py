...
"""Verify that starting blinkhash with -h works as expected."""

from test_framework.test_framework import BlinkhashTestFramework
from test_framework.util import assert_equal

class HelpTest(BlinkhashTestFramework):
    ...
    def run_test(self):
        self.log.info("Start blinkhash with -h for help text")
        ...
        self.log.info("Start blinkhash with -version for version information")
        ...
        self.log.info("Start blinkhashd with -fakearg to make sure it does not start")
