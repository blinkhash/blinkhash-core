...
class InvalidMessagesTest(BlinkhashTestFramework):
    ...
    def test_addrv2(self, label, required_log_messages, raw_addrv2):
        ...
        # Make sure blinkhashd signals support for ADDRv2, otherwise this test
    ...
    def test_resource_exhaustion(self):
        ...
        self.log.info("(a) Send 80 messages, each of maximum valid data size (32MB)")
        for _ in range(80):
