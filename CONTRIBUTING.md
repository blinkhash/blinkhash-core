Contributing to Blinkhash Core
============================

The Blinkhash Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "Blinkhash Core
...
Before you start contributing, familiarize yourself with the Blinkhash Core build
system and tests. Refer to the documentation in the repository on how to build
Blinkhash Core and how to run the unit tests, functional tests, and fuzz tests.
...
[Blinkhash Core PR Review Club](https://bitcoincore.reviews/) meeting.
...
Most communication about Blinkhash Core development happens on IRC, in the
`#blinkhash-core-dev` channel on Libera Chat. The easiest way to participate on IRC is
with the web client, [web.libera.chat](https://web.libera.chat/#blinkhash-core-dev). Chat
...
For all other issues and pull requests, the https://github.com/blinkhash/blinkhash-core node repository should be used.
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to blinkhash-qt
...
fork of Blinkhash Core copies the merge. Instead, make any username mentions in a
...
The following applies to code changes to the Blinkhash Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Blinkhash
Network Protocol consensus changes.

Whether a pull request is merged into Blinkhash Core rests with the project merge
...
Patches that change Blinkhash consensus rules are considerably more involved than
...
Where a patch set proposes to change the Blinkhash consensus, it must have been
...
The project leader is the release manager for each Blinkhash Core release.
