...
Arguments:
    <base_directory> - The base directory of a blinkhash source code repository.
...
Arguments:
    <file> - A source file in the blinkhash repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Blinkhash
