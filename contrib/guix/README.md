# Bootstrappable Blinkhash Core Builds

This directory contains the files necessary to perform bootstrappable Blinkhash
Core builds.
...
To build Blinkhash Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Blinkhash Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/blinkhash-detached-sigs> ./contrib/guix/guix-codesign
```
