...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef BLINKHASH_CHAINPARAMSSEEDS_H\n')
    g.write('#define BLINKHASH_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the blinkhash network\n')
    ...
    g.write('#endif // BLINKHASH_CHAINPARAMSSEEDS_H\n')
